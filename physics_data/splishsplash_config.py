...
SIMULATOR_BIN = "/home/abslon/Workspace/SPlisHSPlasH-2.4.0/bin/DynamicBoundarySimulator"
...
def _set_splishsplash_bin_paths(simulator_bin_path):
    ...
    if not os.path.isfile(volume_sampling_bin_path):
        raise FileNotFoundError(
            "Cannot find the VolumeSampling binary in the same dir as the simulator."
            "Please check the path to the simulator."
        )
